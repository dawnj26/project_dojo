...
<div class="relative p-10 flex flex-col items-center justify-center w-10/12 h-auto m-auto">
        ...
        <h1 class=" text-slate-600 font-medium text-xl mb-5">{{ $totalEpisode }} Episodes | {{ $rating }} / 100 score</h1>
    ...
    <div class=" mb-9">
        ...
        <select class=" border-solid px-10 py-2 border-2 text-xl border-slate-800 rounded-lg " name="" id="">
